...
func TestRenderIconOverrides(t *testing.T) {
	statuses := []agent.Status{agent.StatusWorking, agent.StatusWorking}
	...
	want := "#[fg=magenta][@]#[default]-#[fg=yellow]⚙️2#[default] "
	if got != want {
...
func TestRenderWarnSegment(t *testing.T) {
	...
	want := "#[fg=cyan]🤖#[default]-#[fg=green]⚡️1#[default]-#[fg=yellow]⚠️#[default] "
	if got != want {
	...
	want = "#[fg=cyan][@]#[default]-#[fg=green]W1#[default]-#[fg=yellow]!#[default] "
	if got != want {
	...
	want = "#[fg=#88c0d0]🤖#[default]-#[fg=#a3be8c]⚡️1#[default]-#[fg=#ebcb8b]⚠️#[default] "
	if got != want {
	...
	got = Render(agents, false, theme.Resolve(theme.Options{}), 85)
	want = "#[fg=cyan]🤖#[default]-#[fg=green]⚡️1#[default] "
	if got != want {
		t.Errorf("Render(26%%) =\n  %q\nwant:\n  %q", got, want)
	}
